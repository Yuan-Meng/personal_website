...
Every year around August, you'll start to see openings with "New Grad", "University Grad", "Masters/PhD Graduate", etc. in the job titles. Take advantage of them if you're a current study. University recruiting is special in several regards: 
...
Her words shifted my perspective. If I couldn't get a job in November, so what? I'd make time for job search while doing my dissertation. The only thing I could control was to give my interviewers thoughtful answers, and hopefully, an "entertaining" performance. I got offers from all the later interviews. 
