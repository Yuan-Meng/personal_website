...
- **Metric design**: Come up with or choose metrics that appropriately capture the goodness of a product/feature (using A/B testing to make launch decisions or measure success of past launches) or a model (ML system design)
...
Since interviews tend to mimic real-life problems, I sometimes imagined if only I could work as product data scientist for a week, choosing and debugging metrics would probably have made much more sense ("纸上得来终觉浅")... I'll revisit this writing after having worked on actual products in the not-so-distant future. 

Meanwhile, I often hear fellow grads complaining it's "unfair" for companies ask product or even A/B testing questions since we have no experience — whenever someone says that, I think about law or med school students: Before working on actual court cases or patients, it's possible and desirable have the theoretical foundations. And if you find this process fun, more reasons to make it your career.