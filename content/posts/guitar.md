...
I've been taking guitar lessons over Zoom since the pandemic began. As an electric player, I initially found it challenging to split audio inputs/outputs multiple ways: 
